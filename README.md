...
I have a secrets.nix file to keep somewhat sensitive information..? It's not really that sensitive, but it's things for convience of setting up your own username, location, etc.
